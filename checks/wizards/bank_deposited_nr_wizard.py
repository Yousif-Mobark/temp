...
class BankDepositedNRWizard(models.TransientModel):
    _name = 'bank.deposited.nr.wizard'
    _description = 'Bank Deposited NR Wizard'
    ...
    def do_action(self):
        ...
        if active_id:
            ...
            if not self.in_bank_journal_id.default_debit_account_id:
            ...
            line = (0, 0, {'account_id': self.in_bank_journal_id.default_debit_account_id.id,
