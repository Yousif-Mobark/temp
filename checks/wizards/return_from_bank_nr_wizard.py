...
class ReturnFromBankNRWizard(models.TransientModel):
    _name = 'return.from.bank.nr.wizard'
    _description = 'Return from Bank NR Wizard'
    ...
    def do_action(self):
        ...
        if active_id:
            ...
            if not self.journal_id.default_debit_account_id:
                raise ValidationError(_("You must determine the default account of the selected Journal!"))
